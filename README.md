...
To find the Operator ID, you can do a simple `curl` request to the air conditioner's IP address. The command name must be included in the URL path (`/beaver/command/<command>`).
